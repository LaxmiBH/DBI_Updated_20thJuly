Feature: Shift-Break as Start and End Time Unpaid Functionality

  Scenario: Start and End Time Unpaid
    ...
    And In "Name:" textbox User Enter "SEUnpaid"
    And In "Abbreviation:" textbox User Enter "unpaid"
    And In "Code:" textbox User Enter "SE-40"
    And In Duration User Enter "M:" as "40"
    And In MaxDuration User Enter "M:" as "45"
    ...
    When User enters "SEUnpaid" characters in Search bar
    Then Break "SEUnpaid" should be displayed
    ...
    Then User clicks "SEUnpaid" dropdown on Attendance Punch Clock
    And Select "SEUnpaid" break from dropdown
    ...
    And User clicks on "Punch Clock" option from left on Remote Payroll Settings
    When User clicks "Manage Punch Clock Breaks" button on Remote Payroll Settings
    Then Delete the "SEUnpaid" break from Manage Punch Clock Breaks
